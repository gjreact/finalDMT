  ...
  return <div className="App">
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/remitter" element={<BasicLayout><RemitterInfoPage/></BasicLayout>}/>
        ...
        <Route path="/remitter-getbalance" element={<BasicLayout><RemitterBalancePage/></BasicLayout>}/>
          
        <Route path='/beneficiary-create' element={<BasicLayout><BeneficiaryCreatePage/></BasicLayout>}/>
        ...
        <Route path='/send-money' element={<BasicLayout><SendMoneyPage/></BasicLayout>}/>
        <Route path='/transaction-requery' element={<BasicLayout><TransactionRequeryPage/></BasicLayout>}/>
      </Routes>
    </Router>

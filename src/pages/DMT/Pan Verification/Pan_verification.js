    ...
    <div>
      ...
      <Bar />
        ...
        <h1 className="mb-0 mt-0 heading " >Pan Verification</h1>
          ...
          All API requests must be authenticated with a developer_key in the request.
          Your API keys carry many privileges, so be sure to keep them secret!

          <br/>  
           
          
            You authenticate to the Payment API by providing your API key in the header of
            each request.

            <br/>  

            We only accept requests from shared IP with us. So you should validate your IP
            with our platform
            </p>
            ...
            <ol>
              ...
              <li>Integration has been completed on UAT with signoff from Eko team</li>
              <li>For UAT, a dummy developer_key can be Given while you contact our Team</li>
            </ol>
            </p>
            ...
            whitelisting your server IP with us. You can whitelist 3 IP s at a time.

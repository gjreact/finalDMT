...
const JavaWrapper = () => {
  return <>      <span className="d-flex justify-content-between"><code className="text-white">OkHttpClient client = <code>new</code> <code className="text-white">OkHttpClient().newBuilder()</code></code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("java")} /></span>  

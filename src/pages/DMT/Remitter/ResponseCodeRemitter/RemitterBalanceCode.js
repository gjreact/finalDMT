...
<div className="request-wrapper">
 ...
 <code>var<code  className="text-white">client =</code> new </code><code  className="text-white"> RestClient<code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/check-balance"</code>);</code>
  ...
  return <>
     <CodeWrapper heading="Request">
       ...
       <code className="text-white">require</code><code className="code-yellow">"uri"</code><br/>
         ...
         <code className="text-white">url = URI</code><code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/check-balance")</code><br/>
         ...
         <code className="text-white">request.body = JSON.dump(<span className="output"><br/><code className="code-yellow">"remitterPhone": "7902626443"<br/></code></span>)</code><br/>
  ...
  return <>
     <CodeWrapper heading="Request">
        ...
        <div>
         ...
         <code className="text-white">$body = <span className="output code-yellow"><br/> <span className="text-white">'n</span> `"remitterPhone`":`"7902626443`"<br/><code className="text-white">'n"<br/></code></span></code>
         <code className="text-white">$response = Invoke-RestMethod</code><code className="code-yellow">'http://194.195.113.218:8090/paymento/remitter-reg/check-balance'<span className="text-white">-Method </span>'POST'<span className="text-white">-Headers $headers -Body $body</span></code><br/>

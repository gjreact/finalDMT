...
return <>
        ...
        <span className="d-flex justify-content-between "><code className="text-white">OkHttpClient client = <code >new</code>  OkHttpClient().newnewBuilder()</code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
...
return  <>
    ...
    <br/><span className="d-flex justify-content-between "> <code>import  <code className="text-white">requests</code></code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
...
<ShellWrapper/>
 ...
 export const PHPResendOtp= () => {
   ...
   <div className="request-wrapper">
            <span className="d-flex justify-content-between "><code>	&#60;&#63;php</code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
...
export function GonativeResendOtp(){
 ...
 <div className="request-wrapper">
    <br/><span className="d-flex justify-content-between "><code>package<code className="text-white"> main</code></code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span> 
 ...
 <div className="request-wrapper">
   <span className="d-flex justify-content-between "><code className="text-white">CURL *curl;</code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
     ...
     <>
       <CodeWrapper heading="Request">
         <div className="request-wrapper" id="Ruby">
           <div>
             <span className="d-flex justify-content-between "><code className="text-white">require <code className="code-yellow">"uri"</code></code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
     ...
     <>
       <CodeWrapper heading="Request">
         <div className="request-wrapper" id="Powershell">
           <div>
             <span className="d-flex justify-content-between "><code className="text-white">$headers = New-Object</code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("node")} />  </span>
             <code className="code-yellow">

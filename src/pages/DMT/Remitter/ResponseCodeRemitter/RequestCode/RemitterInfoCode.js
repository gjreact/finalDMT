...
export const PHPRemitter = () => {
  return <>
    <CodeWrapper heading="Request" id="php">
    ...
    <>
      <CodeWrapper heading="Request">
        ...
        <div className="request-wrapper" id="C">
          <span className="d-flex justify-content-between "><code className="text-white">CURL *curl;</code><AiOutlineCopy className="copyicon" onClick={() => copyToClipboard("C")} /></span>
      ...
      <CodeWrapper heading="Request">
        ...
        <div className="request-wrapper" id="C-sharp">
          ...
          <br /><code>var</code> <code className="text-white"> body = </code><code className="code-yellow" > @"</code><code className="output code-yellow ">
            ...
            <br /><code className="code-yellow" >@"       ""remitterphone"":""7902900295""</code>
    ...
    <>
      <CodeWrapper heading="Request">
        ...
        <div className="request-wrapper" id="ruby">
          ...
          <code className="text-white">url = URI</code><code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/remitter-verify")</code><br />
          ...
          <code className="text-white">request.body = JSON.dump(<span className="output"><br /><code className="code-yellow">"remitterPhone": "7902900295"<br /></code></span>)</code><br />
    ...
    <>
      <CodeWrapper heading="Request">
        ...
        <div className="request-wrapper" id="powershell">
          <div>
            <span className="d-flex justify-content-between "><code className="text-white">$headers = New-Object<code className="code-yellow">"System.collections.Generic.Dictionary[String],[String]"</code></code><AiOutlineCopy className="copyicon" style={{width:"50px"}} onClick={() => copyToClipboard("powershell")} /></span>
            <code className="text-white">$headers.Add</code><code className="code-yellow">("apikey", "lScaZNyjCrMrTq1AeTWFK9zEEnlMl9No")</code><br />
            <code className="text-white">$headers.Add</code><code className="code-yellow">("Authorization", "Bearer<span className="output"><span className="output">tokken</span></span>)</code>
            <code className="text-white">$headers.Add</code><code className="code-yellow">("Content-Type", "application/json")</code><br />
            <code className="text-white">$body = <span className="output code-yellow"> <span className="text-white">'n</span> `"remitterPhone`":`"7902900295`"<br /><code className="text-white">'n"</code></span></code>
            <code className="text-white">$response = Invoke-RestMethod</code><code className="code-yellow">'http://194.195.113.218:8090/paymento/remitter-reg/remitter-verify'<span className="text-white">-Method </span>'POST'<span className="text-white">-Headers $headers -Body $body</span></code><br />

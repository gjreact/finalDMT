...
export const JavaVerifyOtp = () => {
   return <> <CodeWrapper heading="Request">
      ...
      <div className="request-wrapper" id="java" >
         ...
         <JavaWrapper />
        <code className="text-white">OkHttpClient client = <code >new</code>  OkHttpClient().newnewBuilder()</code>
      ...
      <CodeWrapper heading="Request">
         <div className="request-wrapper" id="shell">
            ...
            <ShellWrapper />
                 ...
                 <code className="text-white">wget --no-check-certificate --quiet \</code>  

...
export function GonativeVerifyOtp(){
 ...
 <div className="request-wrapper"> 
   ...
   <br/><code className="text-white"> url := </code><code className="code-yellow">"http://194.195.113.218:8090/paymento/remitter-reg/verify-otp"</code>
   ...
   <br/><code className="code-yellow">"+`</code>
   <br/><code className="text-white">"otp":<code className="code-yellow">"017111"</code>`+"</code>
   <br/><code className="code-yellow">"+`</code>
   <br/><code className="text-white">"otpRefferenceId":<code className="code-yellow">"URMDiiD2UQkIkkQy"</code>`+"</code>
   <br/><code className="code-yellow">"+`</code>
   <br/><code className="text-white">"mobile":<code className="code-yellow">"7902626443"</code>`+"</code>
   <br/><code className="code-yellow">"+`</code>
   <br/><code className="text-white">"remitterType":<code className="code-yellow">3</code>`+"</code>
 ...
 <div className="request-wrapper">
  <code>var<code  className="text-white">client =</code> new </code><code  className="text-white"> RestClient<code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/verify-otp"</code>);</code>
  ...
  <br/><code>var</code> <code className="text-white"> body = </code><code className="code-yellow" > @"</code><code className="output code-yellow ">
   ...
   <br/><code className="code-yellow" >@"       ""otp"":""017111"",</code>
 
   <br/><code className="code-yellow" >" <code className="text-white">+ <code className="code-yellow">"\n"</code>+ </code></code>
   <br/><code className="code-yellow" >@"       ""otpRefferenceId"":""URMDiiD2UQkIkkQy"",</code>
 
 <br/><code className="code-yellow" >" <code className="text-white">+ <code className="code-yellow">"\n"</code>+ </code></code>
 <br/><code className="code-yellow" >@"       ""mobile"":""7902626443"",</code>
 
 <br/><code className="code-yellow" >" <code className="text-white">+ <code className="code-yellow">"\n"</code>+ </code></code>
 <br/><code className="code-yellow" >@"       ""remitterType"":3,</code>
 ...
 <div className="request-wrapper">
   ...
   <br/><code className="text-white">curl_easy_setopt(curl, CURLOPT_URL, <code className="code-yellow" >"http://194.195.113.218:8090/paymento/remitter-reg/verify-otp"</code>);</code>
...
export const RubyVerifyOtpCode = () => {
  return <>
     <CodeWrapper heading="Request">
        ...
        <div>
       <code className="text-white">require</code><code className="code-yellow">"uri"</code><br/>
         <code className="text-white">require</code><code className="code-yellow">"json"</code><br/>
         <code className="text-white">require</code><code className="code-yellow">"net/http"</code><br/>
         <code className="text-white">url = URI</code><code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/verify-otp")</code><br/>
         <code className="text-white">http = Net<code>::</code>HTTP.new(url.host, url.port);</code><br/>
         <code className="text-white">request = Net<code>::</code>HTTP<code>::</code>Post.new(url)</code><br/>
         
         <code className="text-white"> request<span className="code-yellow"> ["apikey"]<span className="text-white"> = </span>"lScaZNyjCrMrTq1AeTWFK9zEEnlMl9No"<br/></span></code>
         <code className="text-white"> request<span className="code-yellow"> ["Authorization"]<span className="text-white"> = </span>"Bearer"<span className="output"><span className="output">token</span></span><br/></span></code><br/>
         <code className="text-white"> request<span className="code-yellow"> ["Content-Type"]<span className="text-white"> = </span>"application/json"<br/></span></code><br/>
         <code className="text-white">request.body = JSON.dump(<span className="output"><br/><code className="code-yellow"> "otp":"017111",<br/>"otpRefferenceId":"URMDiiD2UQkIkkQy",<br/>"mobile":"7902626443",<br/> "remitterType":3<br/></code></span>)</code><br/>
         <code className="text-white">response = http.request(request)</code><br/>
...
export const PowershellVerifyOtpCode = () => {
  return <>
     <CodeWrapper heading="Request">
        ...
        <div>
         <code className="text-white">$headers = New-Object</code><code className="code-yellow">"System.collections.Generic.Dictionary[String],[String]"</code><br/>
         <code className="text-white">$headers.Add</code><code className="code-yellow">("apikey", "lScaZNyjCrMrTq1AeTWFK9zEEnlMl9No")</code><br/>
         <code className="text-white">$headers.Add</code><code className="code-yellow">("Authorization", "Bearer<span className="output"><span className="output">tokken</span></span>)</code><br/>
         <code className="text-white">$headers.Add</code><code className="code-yellow">("Content-Type", "application/json")</code><br/>
         <code className="text-white">$body = <span className="output code-yellow"><br/> <span className="text-white">'n</span> `"otp`":`"017111`",<br/><span className="text-white">'n</span>`"otpRefferenceId`":`"URMDiiD2UQkIkkQy`",<br/><span className="text-white">'n</span>`"mobile`":`"7902626443`",<br/><span className="text-white">'n</span>`"remitterType`":3<br/><code className="text-white">'n"<br/></code></span></code><br/>
         <code className="text-white">$response = Invoke-RestMethod</code><code className="code-yellow">'http://194.195.113.218:8090/paymento/remitter-reg/verify-otp'<span className="text-white">-Method </span>'POST'<span className="text-white">-Headers $headers -Body $body</span></code><br/>

...
export const PHPBeneficiary = () => {
   return <>
      <CodeWrapper heading="Request">
         ...
         <div className="request-wrapper">
              <span className="d-flex justify-content-between"><code>	&#60;&#63;php</code> <AiOutlineCopy
          className="copyicon"
          onClick={() => copyToClipboard("java")}
        />
      </span>
...
export const JavascriptRegisterBeneficiary = () => {
   return <>
      <CodeWrapper heading="Request">
         ...
         <div className="request-wrapper">
            <br />   <span className="d-flex justify-content-between"><code>var myHeaders = <code>new</code> <code className="text-white">Headers();</code></code> <AiOutlineCopy
          className="copyicon"
          onClick={() => copyToClipboard("java")}
        />
      </span>
   ...
   return <>
      <CodeWrapper heading="Request">
         <div className="request-wrapper">
           ...
           <span className="d-flex justify-content-between"><code>import <code className="text-white">Foundation</code></code> <AiOutlineCopy
          className="copyicon"
          onClick={() => copyToClipboard("java")}
        />
      </span>
...
export function GonativeBeneficiaryRegister(){
 ...
 <div className="request-wrapper">
    <span className="d-flex justify-content-between"><code>var <code  className="text-white">client = </code> new <code  className="text-white"> RestClient<code className="code-yellow">(""http://194.195.113.218:8090/paymento/beneficiary-reg/add-beneficiary""</code>);</code></code> <AiOutlineCopy
          className="copyicon"
          style={{width:"50px"}}
          onClick={() => copyToClipboard("java")}
        />

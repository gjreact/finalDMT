...
<span  className="d-flex justify-content-between"><code className="text-white">$curl = curl_init();</code><AiOutlineCopy className="copyicon" onClick={()=>copyToClipboard("python")} /></span>
  ...
  export const NodeDeleteBeneficiary= () => {
   return <> <CodeWrapper heading="Request">
     ...
     <code>var </code> <code className="text-white">options = </code><span className="output text-white"><br />
        ...
        <code>'url' :<code className="code-yellow">'http://194.195.113.218:8090/paymento/remitter-reg/delete-beneficiary\n',</code></code><br />
        <code className="text-white">
               headers = <span className="output  text-white"><br />
                  <code>'apiKey'</code>: <code className="code-yellow">'apiKey'</code> ,<br />
                  <code >'Authorization'</code>: <code className="code-yellow">'Bearer  token'</code>,<br />
...
export function ClibcurlBeneficiaryDelete(){
 ...
 <div className="request-wrapper">
   ...
   <br/><code className="text-white">curl_easy_setopt(curl, CURLOPT_URL, <code className="code-yellow" >"http://194.195.113.218:8090/paymento/remitter-reg/delete-beneficiary"</code>);</code>
 ...
 <div className="request-wrapper">
   ...
   <br/><code className="text-white"> url := </code><code className="code-yellow">"http://194.195.113.218:8090/paymento/remitter-reg/delete-beneficiary"</code>

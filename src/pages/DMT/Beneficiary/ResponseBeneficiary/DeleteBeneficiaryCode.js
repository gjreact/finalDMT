...
export function ClibcurlBeneficiaryDelete(){
 ...
 <div className="request-wrapper">
 <code>var<code  className="text-white">client =</code> new </code><code  className="text-white"> RestClient<code className="code-yellow">("http://194.195.113.218:8090/paymento/remitter-reg/delete-beneficiary"</code>);</code>
